...
//bootstrap import igual que en react
/*
{
...
function render(variables = {}) {
  ...
  if (variables.name != null) {
    name = `"<div class='cover'>"${variables.name}"</div>";`;
  }
...
//merge une dos ramas Vercel-Surge-Firebase-Servidor de Google y de apps-AWS muy solicitud-ambos son gratuitos y con base al uso  deployments front end Heroku puede llegar a ser compleja
  ...
  //.render en javascript .reactDom y ya se hace lo mismo con esa funcion
}
...
window.onload = function() {
  //solamente en javascript, no va a ser la norma
  //react de alguna manera ya lo resuelve
  window.variables = {
